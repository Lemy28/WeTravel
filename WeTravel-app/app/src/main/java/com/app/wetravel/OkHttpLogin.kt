...
class OkHttpLogin(private val phoneNumber:String,private val password: String) : AsyncTask<Void, Void, String>() {
    companion object {

        private const val TAG = "Net"
        private const val SERVER_URL = "http://39.107.60.28:8014/userLogin" // 服务器URL
    }
